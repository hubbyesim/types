...
function createServerSchemaBuilder(db) {
  return function buildServerSchema2(spec, path = []) {
    ...
    if ("_type" in spec && spec._type === "array") {
      ...
      const itemSchema = spec.of instanceof z.ZodType ? spec.of : buildServerSchema2(spec.of, [...path, "[i]"]);
    ...
    if ("_type" in spec && spec._type === "record") {
      ...
      const valueSchema = spec.of instanceof z.ZodType ? spec.of : buildServerSchema2(spec.of, [...path, "[key]"]);
